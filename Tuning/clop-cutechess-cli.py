...
options = '-each tc=5 -draw movenumber=80 movecount=5 score=5 -resign movecount=5 score=500 -repeat -openings file=/ssd/Minic/Book_and_Test/OpeningBook/Hert500.pgn format=pgn order=random plies=24'
